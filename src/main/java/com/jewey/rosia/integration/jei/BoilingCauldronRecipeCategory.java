...
public class BoilingCauldronRecipeCategory implements IRecipeCategory<BoilingCauldronRecipe> {
    ...
    @Override
    public void draw(BoilingCauldronRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
    ...
    @Override
    public Class<? extends BoilingCauldronRecipe> getRecipeClass() {
        return BoilingCauldronRecipe.class;
    }
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull BoilingCauldronRecipe recipe, @Nonnull IFocusGroup focusGroup) {
        ...
        {
            builder.addSlot(RecipeIngredientRole.OUTPUT, 77, 15).addItemStack(recipe.getResultItem());
        }
    }
}
