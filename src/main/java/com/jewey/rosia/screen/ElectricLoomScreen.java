...
public class ElectricLoomScreen extends BlockEntityScreen<ElectricLoomBlockEntity, ElectricLoomContainer>
{
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Rosia.MOD_ID, "textures/gui/electric_loom_gui.png");

    public ElectricLoomScreen(ElectricLoomContainer container, Inventory playerInventory, Component name)
    {
