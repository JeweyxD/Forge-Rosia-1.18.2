...
public class ExtrudingMachineContainer extends BlockEntityContainer<ExtrudingMachineBlockEntity>
{
    public static ExtrudingMachineContainer create(ExtrudingMachineBlockEntity entity, Inventory playerInventory, int windowId)
    {
        return new ExtrudingMachineContainer(entity, windowId).init(playerInventory, 0);
    }


    private ExtrudingMachineContainer(ExtrudingMachineBlockEntity entity, int windowId)
    {
        super(ModContainerTypes.EXTRUDING_MACHINE.get(), windowId, entity);
