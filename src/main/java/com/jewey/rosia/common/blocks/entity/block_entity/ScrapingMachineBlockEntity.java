...
import com.jewey.rosia.common.blocks.custom.scraping_machine;
...
public class ScrapingMachineBlockEntity extends TickableInventoryBlockEntity<ItemStackHandler> implements MenuProvider
{
    ...
    private static final TranslatableComponent NAME = Helpers.translatable(MOD_ID + ".block_entity.scraping_machine");
