...
public class RollingMachineBlockEntity extends TickableInventoryBlockEntity<ItemStackHandler> implements MenuProvider
{
    ...
    private final ItemStackHandler itemHandler = new ItemStackHandler(3) {
        ...
        public boolean isItemValid(int slot, @NotNull ItemStack stack) {  //Use for hopper interaction
            return switch (slot) {
                ...
                case 1 -> stack.getItem() != ModItems.STEEL_ROLLERS.get();  //Prevent multiple tools being inserted
                case 2 -> false;
    ...
    private static final TranslatableComponent NAME = Helpers.translatable(MOD_ID + ".block_entity.rolling_machine");
    ...
    {
        super(ModBlockEntities.ROLLING_MACHINE_BLOCK_ENTITY.get(), pos, state, defaultInventory(3), NAME);
    ...
    public AbstractContainerMenu createMenu(int pContainerId, Inventory pPlayerInventory, Player pPlayer)
    {
        ...
        return RollingMachineContainer.create(this, pPlayerInventory, pContainerId);
    }
    ...
    private static boolean hasToolsInToolSlot(RollingMachineBlockEntity entity) {
        return entity.inventory.getStackInSlot(0).getItem() == ModItems.STEEL_ROLLERS.get();
    }
